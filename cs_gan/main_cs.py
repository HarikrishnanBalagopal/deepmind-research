...
flags.DEFINE_string("mode", "recons", "Model mode.")
flags.DEFINE_integer(
    "num_training_iterations", 10000000, "Number of training iterations."
)
flags.DEFINE_integer("batch_size", 64, "Training batch size.")
flags.DEFINE_integer("num_measurements", 25, "The number of measurements")
flags.DEFINE_integer("num_latents", 100, "The number of latents")
flags.DEFINE_integer("num_z_iters", 3, "The number of latent optimisation steps.")
...
flags.DEFINE_string("dataset", "mnist", "The dataset used for learning (cifar|mnist.")
...
def main(argv):
    ...
    hooks = [checkpoint_saver_hook, nan_hook, step_conter_hook, loss_summary_saver_hook]
