...
def _connect_module_with_kwarg_if_supported(
    module, input_tensor, kwarg_name, kwarg_value
):
...
class KeyPointer(snt.AbstractModule):
    ...
    """
        ...
        return get_keypoint_data_from_feature_map(keypoint_features, self._gauss_std)
