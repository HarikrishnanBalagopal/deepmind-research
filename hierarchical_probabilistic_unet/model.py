...
class HierarchicalProbUNet(snt.AbstractModule):
    ...
    """
        ...
        if self._cache == inputs:
            ...
            self._q_sample = self._posterior(tf.concat([seg, img], axis=-1), mean=False)
    ...
    """
        ...
        kl_sum = tf.reduce_sum(tf.stack([kl for _, kl in kl_dict.iteritems()], axis=-1))
