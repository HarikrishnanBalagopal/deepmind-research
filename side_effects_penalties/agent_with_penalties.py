...
class QLearningSE(agent.QLearning):
    ...
    """
        ...
        super(QLearningSE, self).__init__(
            actions, alpha, epsilon, q_initialisation, discount
        )
        ...
        if dev_measure in {"reach", "rel_reach"}:
            ...
            deviation = sep.AttainableUtility(
                value_discount, dev_fun, num_util_funs, discount
            )
        ...
        use_inseparable_rollout = dev_measure == "reach" and baseline == "stepwise"
        ...
        if baseline in {"start", "inaction", "stepwise"}:
            ...
            baseline = baseline_class(
                start_timestep, exact_baseline, baseline_env, self._timestep_to_state
            )
        ...
        self._impact_penalty = sep.SideEffectPenalty(
            baseline, deviation, beta, use_inseparable_rollout
        )
